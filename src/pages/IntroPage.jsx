    ...
    <div style={{fontFamily:"'Noto Sans KR',sans-serif",background:'#f8f7f4',minHeight:'100vh',color:'#1a1a18'}}>
      ...
      <div style={{background:'#0F1F15',color:'white',padding:'52px 24px 48px',textAlign:'center',position:'relative',overflow:'hidden'}}>
        ...
        <div style={{position:'relative'}}>
          ...
          <div style={{display:'inline-flex',alignItems:'center',gap:10,background:'rgba(255,255,255,0.07)',border:'0.5px solid rgba(255,255,255,0.12)',borderRadius:12,padding:'8px 18px',marginBottom:28}}>
            <div style={{width:28,height:28,borderRadius:'50%',background:'#E8211A',display:'flex',alignItems:'center',justifyContent:'center',fontSize:14,color:'white',fontWeight:700,flexShrink:0}}>
          ...
          <a href="tel:01033385512"
            style={{display:'inline-block',background:'#1D9E75',color:'white',borderRadius:10,padding:'12px 36px',fontSize:14,fontWeight:700,textDecoration:'none',boxShadow:'0 4px 16px rgba(29,158,117,0.4)'}}>
            📞 전화 상담하기
          </a>
        </div>
      </div>
      ...
      <div style={{background:'#f8f7f4',padding:'36px 24px 48px',textAlign:'center'}}>
        <div style={{maxWidth:400,margin:'0 auto'}}>
          ...
          <a href="tel:01033385512"
            style={{display:'block',background:'#1D9E75',color:'white',borderRadius:12,padding:'14px',fontSize:15,fontWeight:700,textDecoration:'none',marginBottom:8,boxShadow:'0 4px 16px rgba(29,158,117,0.25)'}}>
            📞 010-3338-5512
          </a>
          <a href="tel:05598967800"
            style={{display:'block',background:'white',color:'#555',borderRadius:12,padding:'13px',fontSize:13,fontWeight:500,textDecoration:'none',marginBottom:8,border:'0.5px solid rgba(0,0,0,0.10)'}}>
            ☎ 055-986-7800 (사무실)
          </a>
          <a href="mailto:hjpark94@hafeed.com"
            style={{display:'block',background:'white',color:'#555',borderRadius:12,padding:'13px',fontSize:13,fontWeight:500,textDecoration:'none',border:'0.5px solid rgba(0,0,0,0.10)'}}>
            ✉ hjpark94@hafeed.com
          </a>
